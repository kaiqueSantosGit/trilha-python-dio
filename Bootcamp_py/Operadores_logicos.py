"""São operadores utilizados em conjunto com os operadores de comparação, para montar uma expressão lógica. 
  quando um operador de comparação é utilizado, o resultado retornado é um booleano, dessas forma podemos combinar
  operadores de comparação com os operadores lógicos, exemplo 
